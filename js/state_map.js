    ...
    var usa = topojson.feature(json, json.objects.states).features;
      ...
      for (var j in usa){
        ...
        if (stateCode == iD) {
          ...
          usa[j].properties.diffMMResettled14_18 = +usa[j].properties.resettledMM2018 - +usa[j].properties.resettled2014
...
var color = d3.scaleQuantize()
    ...
    .range(["#7aa25c","#89ab6e", "#a0b98a", "#beccae"]);
    //"#b6c7a5","#a7be93","#98b580","#91b077",,"#82a765","#afc39c"
...
function showDetail(d) {
  ...
  var content = '<span class="name">State: </span><span class="value">' +
                d.State +
                '</span><br/>' +
                '<span class="name">Change in Cases Resettled: </span><span class="value">' +
                addCommas(+d.properties.resettled2018 - +d.properties.resettled2014) + 
                '</span><br/>' +
                '<span class="name">from Muslim-Majority Countries: </span><span class="value">' +
